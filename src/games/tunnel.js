...
var tunnerl = function() {
	...
	const infoObject = {
        name: 'Tunnerl',
        description: 'Find your way through the tunnel.',
        shortDescription: 'Find your way through the tunnel.',
        imgUrl: 'tunnel.jpg',
        manual: 'Use "A" and "D" or "left" and "right" to avoid hitting the walls.',
        file: 'tunnel.js'
    }
